...
<body>
	...
	<nav class="category_menu">
        <ul>
            ...
            <li style="text-decoration:underline;"><a href="<c:url value='/item/season/form'></c:url>">시기</a></li>
	...
	<!--swiper -->
	<div style="margin-top:10px;" align="center">3~5월</div>
	...
	<div style="; margin-top:10px;" align="center">6~8월</div>
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide"><a href="<c:url value='/item/view'>
	...
	<div style=" margin-top:10px;" align="center">9~11월</div>
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide"><a href="<c:url value='/item/view'>
	...
	<div style="margin-top:10px;" align="center">12~1월</div>
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide"><a href="<c:url value='/item/view'>
