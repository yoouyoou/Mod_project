...
<body>
	...
	<nav class="category_menu">
        <ul>
            ...
            <li style="text-decoration:underline;"><a href="<c:url value='/item/theme/form'></c:url>">테마</a></li>
            <li><a href="<c:url value='/item/price/form'></c:url>">가격</a></li>
        </ul>
    </nav>
    
	<!--swiper -->
	<div style= "margin-top:10px;" align="center">가족 여행</div>
	...
	<div style=" margin-top:10px;" align="center">힐링 여행</div>
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide"><a href="<c:url value='/item/view'>
