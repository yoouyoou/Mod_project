...
<body>
	...
	<nav class="category_menu">
        <ul>
            <li><a href="<c:url value='/item/country/form'></c:url>">국가</a></li>  
            <li><a href="<c:url value='/item/season/form'></c:url>">시기</a></li>
            <li><a href="<c:url value='/item/theme/form'></c:url>">테마</a></li>
            <li style="text-decoration:underline;"><a href="<c:url value='/item/price/form'></c:url>">가격</a></li>
        </ul>
    </nav>
    
    <!--swiper -->
	<div style=" margin-top:10px;" align="center">0~50만원</div>
	...
	<div style=" margin-top:10px;" align="center">150~200만원</div>
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide"><a href="<c:url value='/item/view'>
					   <c:param name='itemId' value='12'/>
